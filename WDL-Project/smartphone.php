...
session_start();
$connect = mysqli_connect("localhost", "root", "", "bestbuy");
	...
	<body>
         <!-- <section>
            <div id="main">
                ...
                <a href="#" id="main_name">KC Cafeteria</a>
			...
			<div class="col-md-4">
				<form method="post" action="index.php?action=add&id=<?php echo $row["id"]; ?>">
					<div style="border:3px solid #5cb85c; background-color:whitesmoke; border-radius:2px; padding:16px;" align="center">
						<img src="images/smartphone/<?php echo $row["image"]; ?>" class="img-responsive" style="width: 350px;height: 220px;"/><br />
